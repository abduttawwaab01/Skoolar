  ...
  try {
    ...
    if (schoolJustCreated) {
      ...
      if (freePlan) {
        ...
        // Create a PlatformPayment record for the free plan
      ...
      const academicYear = await db.academicYear.create({
        data: {
          ...
          endDate: new Date(nextYear, 6, 31),     // July 31
          isCurrent: true,
          isLocked: false,
        },
      });
      ...
      await Promise.all([
        db.term.create({
          data: {
            ...
            endDate: new Date(currentYear, 11, 19),    // Dec 19
            isCurrent: false,
            isLocked: false,
          },
        }),
        db.term.create({
          data: {
            ...
            name: 'Second Term',
            order: 2,
            startDate: new Date(nextYear, 0, 7),       // Jan 7
            endDate: new Date(nextYear, 2, 28),         // Mar 28
            isCurrent: true,
            isLocked: false,
          },
        }),
        db.term.create({
          data: {
            ...
            name: 'Third Term',
            order: 3,
            startDate: new Date(nextYear, 3, 21),      // Apr 21
            endDate: new Date(nextYear, 6, 31),         // Jul 31
            isCurrent: false,
            isLocked: false,
          },
        }),
