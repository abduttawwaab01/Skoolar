...
export type DashboardView = 
  ...
  | 'attendance' | 'exams' | 'results' | 'report-cards'
  ...
  | 'class-monitoring' | 'messaging-center';
...
export const useAppStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      selectedTermId: 'term-2',
      setSelectedTermId: (id) => set({ selectedTermId: id }),
      selectedClassId: 'JSS 1A',
...
export const navigationByRole: Record<UserRole, NavItem[]> = {
  ...
  DIRECTOR: [
    ...
    { id: 'attendance', label: 'Attendance Overview', icon: 'calendar-check' },
