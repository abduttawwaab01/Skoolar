...
<body>
  ...
  <div class="footer">
    ...
    <p style="margin-top:0.25rem">Skoolar - Odebunmi Tawwab A</p>
  </div>
</body>
</html>`;
    ...
    return new NextResponse(html, {
      headers: {
        ...
        'Content-Disposition': `inline; filename="scheme-of-work-${scheme.subject.name.toLowerCase().replace(/\s+/g, '-')}-${scheme.term.name.toLowerCase().replace(/\s+/g, '-')}.html"`,
      },
    });
  } catch (error: unknown) {
